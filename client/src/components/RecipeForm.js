      ...
      <div className={styles.RecipeForm}>
        ...
        <form onSubmit={ this.handleFormSubmit }>
          ...
          <div className={styles.formGroup}>
            <ul>
              <li>
                <input type="checkbox" name="vegetarian" checked={ this.state.vegetarian } onChange={ this.handleCheckboxChange }/>
                <label htmlFor="vegetarian">Vegetarian</label>
              </li>
              <li>
                <input type="checkbox" name="vegan" checked={ this.state.vegan } onChange={ this.handleCheckboxChange }/>
                <label htmlFor="vegan">Vegan</label>
              </li>
              <li>
                <input type="checkbox" name="glutenfree" checked={ this.state.glutenfree } onChange={ this.handleCheckboxChange }/>
